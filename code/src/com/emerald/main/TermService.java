...
public class TermService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    public void onCreate() {
        ...
        Notification notification = new Notification(R.drawable.ic_launcher, getText(R.string.service_notify_text), System.currentTimeMillis());
    ...
    private boolean createBashInit(File zHome){
        ...
        try {
            ...
            pw.println("export HOSTNAME=emerald-lite");//+getLocalIpAddress());
            pw.println("");
            ...
            pw.println("#create Emerald Path");
            pw.println("export EMERALDROOT=$HOME/emerald");
            pw.println("export PATH=$PATH:$EMERALDROOT/bin");
            pw.println("");

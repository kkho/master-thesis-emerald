...
import com.emerald.main.TermDebug;
...
public class TermSession {
    ...
    private static final String DEFAULT_INITIAL_COMMAND = "export HOME=/data/data/com.example.master_thesis/files;cd $HOME;export PATH=$HOME/bin:$HOME/bin/bbdir:$PATH;bash";
